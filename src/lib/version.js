...
export async function getSillyTavernVersion(forceRefresh = false) {
    ...
    try {
        ...
        console.error('[Ado Helper] Failed to fetch SillyTavern version:', error);
        return null;
    }
}
...
/**
 * Get the current Ado Helper version with prerelease indicator if applicable
 *
 * @returns {string} Formatted version (e.g., "4.1.8" or "4.1.8-beta.1")
 */
export function getAdoHelperVersion() {
    return EXTENSION_VERSION;
}

/**
 * Get parsed Ado Helper version info
 *
 * @returns {ParsedVersion|null} Parsed version object
 */
export function getParsedAdoHelperVersion() {

/**
 * GuidedGenView — Full Guided Generations management UI for Ado Helper settings.
 *
 * Provides CRUD for guided generation prompts with inline editing,
 * styled with Ado Helper's adaptive theming (var(--ado-*)).
 */
...
const s = {
    ...
    headerTitle: {
        ...
        fontSize: '16px', fontWeight: 600, color: 'var(--ado-text)',
    },
    description: {
        fontSize: '13px', color: 'var(--ado-text-muted)', lineHeight: '1.5', marginBottom: '16px',
    },
    addBtn: {
        display: 'inline-flex', alignItems: 'center', gap: '6px',
        padding: '8px 16px', border: '1px solid var(--ado-border)',
        borderRadius: '10px', background: 'var(--ado-fill-subtle)',
        color: 'var(--ado-text)', fontSize: '13px', fontWeight: 500,
        cursor: 'pointer',
    },
    list: { display: 'flex', flexDirection: 'column', gap: '8px' },
    card: {
        border: '1px solid var(--ado-border)',
        borderRadius: '12px', background: 'var(--ado-fill-subtle)',
        overflow: 'hidden',
    },
    cardHeader: {
    ...
    cardName: {
        fontSize: '14px', fontWeight: 600, color: 'var(--ado-text)',
    ...
    badge: {
        ...
        background: 'var(--ado-fill)', color: 'var(--ado-text-muted)',
    },
    badgePersistent: {
        background: 'var(--ado-primary-008)', color: 'var(--ado-primary-text)',
    },
    cardActions: { display: 'flex', gap: '4px', flexShrink: 0 },
    iconBtn: {
        display: 'flex', alignItems: 'center', justifyContent: 'center',
        width: '32px', height: '32px', border: 'none', borderRadius: '8px',
        background: 'transparent', color: 'var(--ado-text-muted)',
        cursor: 'pointer',
    },
    iconBtnActive: { color: 'var(--ado-primary-text)' },
    // Editor form
    editor: {
        padding: '14px', borderTop: '1px solid var(--ado-border)',
        display: 'flex', flexDirection: 'column', gap: '12px',
    },
    field: { display: 'flex', flexDirection: 'column', gap: '4px' },
    label: {
        fontSize: '11px', fontWeight: 600, color: 'var(--ado-text-muted)',
        textTransform: 'uppercase', letterSpacing: '0.03em',
    },
    input: {
        padding: '8px 12px', border: '1px solid var(--ado-border)',
        borderRadius: '8px', background: 'var(--ado-fill-subtle)',
        color: 'var(--ado-text)', fontSize: '13px', fontFamily: 'inherit',
        outline: 'none',
    },
    textarea: { minHeight: '100px', resize: 'vertical' },
    hint: { fontSize: '11px', color: 'var(--ado-text-muted)' },
    ...
    colorSwatch: (c, active) => ({
        ...
        border: active
            ? '2px solid var(--ado-primary-text)'
            : '1px solid var(--ado-border)',
        background: c || 'var(--ado-fill-subtle)',
    }),
    editorActions: {
    ...
    saveBtn: {
        display: 'inline-flex', alignItems: 'center', gap: '6px',
        padding: '7px 16px', border: '1px solid var(--ado-primary-040)',
        borderRadius: '8px', background: 'var(--ado-primary-020)',
        color: 'var(--ado-primary-text)', fontSize: '13px', fontWeight: 500,
        cursor: 'pointer',
    },
    cancelBtn: {
        display: 'inline-flex', alignItems: 'center', gap: '6px',
        padding: '7px 16px', border: '1px solid var(--ado-border)',
        borderRadius: '8px', background: 'var(--ado-fill-subtle)',
        color: 'var(--ado-text)', fontSize: '13px', fontWeight: 500,
        cursor: 'pointer',
    },
    deleteBtn: {
        ...
        color: 'var(--ado-danger)', fontSize: '13px', fontWeight: 500,
        cursor: 'pointer',
    },
    empty: {
        padding: '40px 20px', textAlign: 'center',
        color: 'var(--ado-text-muted)', fontSize: '13px', lineHeight: '1.6',
    },
    toggleWrapper: {
        display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer',
        fontSize: '13px', color: 'var(--ado-text)',
    },
    toggleTrack: (active) => ({
        width: '36px', height: '20px', borderRadius: '10px', position: 'relative',
        background: active ? 'var(--ado-primary-040)' : 'var(--ado-fill)',
        transition: 'background 0.15s ease', flexShrink: 0,
    }),
    toggleThumb: (active) => ({
        position: 'absolute', top: '2px', left: '2px',
        width: '16px', height: '16px', borderRadius: '50%',
        background: 'var(--ado-text)',
            ...
            <div style={s.cardHeader}>
                ...
                <div style={s.cardInfo}>
                    ...
                    <div style={s.cardMeta}>
                        ...
                        <span style={{ fontSize: '10px', color: 'var(--ado-text-muted)' }}>

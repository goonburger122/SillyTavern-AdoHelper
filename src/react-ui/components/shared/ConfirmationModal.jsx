...
const ConfirmationModal = ({
    ...
    const getVariantStyles = (v = variant) => {
        switch (v) {
            case 'danger':
                return {
                    iconBg: 'var(--ado-danger-015, rgba(239, 68, 68, 0.15))',
                    iconColor: 'var(--ado-danger, #ef4444)',
                    ...
                    confirmBorder: 'var(--ado-danger-050, rgba(239, 68, 68, 0.5))',
                    accentGlow: 'rgba(239, 68, 68, 0.3)',
                    borderAccent: 'var(--ado-danger-020, rgba(239, 68, 68, 0.2))',
                };
            case 'warning':
                return {
                    iconBg: 'rgba(245, 158, 11, 0.15)',
                    iconColor: 'var(--ado-warning, #f59e0b)',
            ...
            default:
                return {
                    iconBg: 'var(--ado-primary-015, rgba(147, 112, 219, 0.15))',
                    iconColor: 'var(--ado-primary, #9370db)',
                    ...
                    confirmBorder: 'var(--ado-primary-050, rgba(147, 112, 219, 0.5))',
                    accentGlow: 'rgba(147, 112, 219, 0.3)',
                    borderAccent: 'var(--ado-primary-020, rgba(147, 112, 219, 0.2))',
                };
        }
    };
    ...
    return createPortal(
        <AnimatePresence>
            {isOpen && (
                <motion.div
                    className="ado-confirm-backdrop"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
